...
%_P3T Applies a projective transformation in 3D.
%
%wt = p3t(T,w) given a transformation T (homogeneous)
%and a set of world points w, allows to calculate
%a transformation of points in 3D space.
...
if na~=4 | ma~=4
    ...
    %Incorrect transformation matrix format (4x4)!!'
end
...
%'World coordinates must be Cartesian!!'
